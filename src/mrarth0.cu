...
__FUNCTION_HEADER__ void mr_padd(_MIPD_ big x, big y, big z) { /*  add two  big numbers, z=x+y where *
...
__FUNCTION_HEADER__ void mr_psub(_MIPD_ big x, big y, big z) {  /*  subtract two big numbers z=x-y      *
...
__FUNCTION_HEADER__ void mr_select(_MIPD_ big x, int d, big y, big z) { /* perform required add or subtract operation */
...
__FUNCTION_HEADER__ void add(_MIPD_ big x, big y, big z) {  /* add two signed big numbers together z=x+y */
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void subtract(_MIPD_ big x, big y, big z) { /* subtract two big signed numbers z=x-y */
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void incr(_MIPD_ big x, int n, big z) {  /* add int to big number: z=x+n */
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void decr(_MIPD_ big x, int n, big z) {  /* subtract int from big number: z=x-n */
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
