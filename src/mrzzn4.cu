...
__FUNCTION_HEADER__ void zzn4_mirvar(_MIPD_ zzn4 *w) {
    zzn2_mirvar(_MIPP_ &(w->a));
    zzn2_mirvar(_MIPP_ &(w->b));
}

__FUNCTION_HEADER__ void zzn4_kill(_MIPD_ zzn4 *w) {
    zzn2_kill(_MIPP_ &(w->a));
    zzn2_kill(_MIPP_ &(w->b));
}

__FUNCTION_HEADER__ BOOL zzn4_iszero(zzn4 *x) {
    if (zzn2_iszero(&(x->a)) && zzn2_iszero(&(x->b))) return TRUE;
    return FALSE;
}

__FUNCTION_HEADER__ BOOL zzn4_isunity(_MIPD_ zzn4 *x) {
#ifdef MR_OS_THREADS
...
__FUNCTION_HEADER__ BOOL zzn4_compare(zzn4 *x, zzn4 *y) {
    if (zzn2_compare(&(x->a), &(y->a)) && zzn2_compare(&(x->b), &(y->b))) return TRUE;
    return FALSE;
}

__FUNCTION_HEADER__ void zzn4_from_int(_MIPD_ int i, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void zzn4_copy(zzn4 *x, zzn4 *w) {
    if (x == w) return;
    zzn2_copy(&(x->a), &(w->a));
    zzn2_copy(&(x->b), &(w->b));
    w->unitary = x->unitary;
...
__FUNCTION_HEADER__ void zzn4_zero(zzn4 *w) {
    zzn2_zero(&(w->a));
    zzn2_zero(&(w->b));
    w->unitary = FALSE;
}

__FUNCTION_HEADER__ void zzn4_from_zzn2s(zzn2 *x, zzn2 *y, zzn4 *w) {
    zzn2_copy(x, &(w->a));
    zzn2_copy(y, &(w->b));
    w->unitary = FALSE;
}

__FUNCTION_HEADER__ void zzn4_from_zzn2(zzn2 *x, zzn4 *w) {
    zzn2_copy(x, &(w->a));
    zzn2_zero(&(w->b));
    w->unitary = FALSE;
}

__FUNCTION_HEADER__ void zzn4_from_zzn2h(zzn2 *x, zzn4 *w) {
    zzn2_copy(x, &(w->b));
    zzn2_zero(&(w->a));
    w->unitary = FALSE;
}

__FUNCTION_HEADER__ void zzn4_from_zzn(big x, zzn4 *w) {
    zzn2_from_zzn(x, &(w->a));
    zzn2_zero(&(w->b));
    w->unitary = FALSE;
}

__FUNCTION_HEADER__ void zzn4_from_big(_MIPD_ big x, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_negate(_MIPD_ zzn4 *x, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_conj(_MIPD_ zzn4 *x, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    MR_IN(FUNC_BASE + 2)
...
__FUNCTION_HEADER__ void zzn4_add(_MIPD_ zzn4 *x, zzn4 *y, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_sadd(_MIPD_ zzn4 *x, zzn2 *y, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_sub(_MIPD_ zzn4 *x, zzn4 *y, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_ssub(_MIPD_ zzn4 *x, zzn2 *y, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_smul(_MIPD_ zzn4 *x, zzn2 *y, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_lmul(_MIPD_ zzn4 *x, big y, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_imul(_MIPD_ zzn4 *x, int y, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_sqr(_MIPD_ zzn4 *x, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    zzn2 t1, t2;
...
__FUNCTION_HEADER__ void zzn4_mul(_MIPD_ zzn4 *x, zzn4 *y, zzn4 *w) {
...
__FUNCTION_HEADER__ void zzn4_inv(_MIPD_ zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    zzn2 t1, t2;
...
__FUNCTION_HEADER__ void zzn4_div2(_MIPD_ zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn4_powq(_MIPD_ zzn2 *fr, zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    MR_IN(FUNC_BASE + 12)
...
__FUNCTION_HEADER__ void zzn4_tx(_MIPD_ zzn4 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    zzn2 t;
