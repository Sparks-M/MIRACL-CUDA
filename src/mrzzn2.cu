...
__FUNCTION_HEADER__ void zzn2_mirvar(_MIPD_ zzn2 *w) {
    w->a = mirvar(_MIPP_ 0);
    w->b = mirvar(_MIPP_ 0);
}

__FUNCTION_HEADER__ void zzn2_kill(_MIPD_ zzn2 *w) {
    mirkill(w->a);
    mirkill(w->b);
}

__FUNCTION_HEADER__ BOOL zzn2_iszero(zzn2 *x) {
    if (size(x->a) == 0 && size(x->b) == 0) return TRUE;
    return FALSE;
}

__FUNCTION_HEADER__ BOOL zzn2_isunity(_MIPD_ zzn2 *x) {
#ifdef MR_OS_THREADS
...
__FUNCTION_HEADER__ BOOL zzn2_compare(zzn2 *x, zzn2 *y) {
    if (mr_compare(x->a, y->a) == 0 && mr_compare(x->b, y->b) == 0) return TRUE;
    return FALSE;
}

__FUNCTION_HEADER__ void zzn2_from_int(_MIPD_ int i, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void zzn2_from_ints(_MIPD_ int i, int j, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_from_zzns(big x, big y, zzn2 *w) {
    copy(x, w->a);
    copy(y, w->b);
}

__FUNCTION_HEADER__ void zzn2_from_bigs(_MIPD_ big x, big y, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_from_zzn(big x, zzn2 *w) {
    copy(x, w->a);
    zero(w->b);
}

__FUNCTION_HEADER__ void zzn2_from_big(_MIPD_ big x, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_copy(zzn2 *x, zzn2 *w) {
    if (x == w) return;
    copy(x->a, w->a);
    copy(x->b, w->b);
}

__FUNCTION_HEADER__ void zzn2_zero(zzn2 *w) {
    zero(w->a);
    zero(w->b);
}

__FUNCTION_HEADER__ void zzn2_negate(_MIPD_ zzn2 *x, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_conj(_MIPD_ zzn2 *x, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    MR_IN(158)
...
__FUNCTION_HEADER__ void zzn2_add(_MIPD_ zzn2 *x, zzn2 *y, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_sadd(_MIPD_ zzn2 *x, big y, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_sub(_MIPD_ zzn2 *x, zzn2 *y, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_ssub(_MIPD_ zzn2 *x, big y, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_smul(_MIPD_ zzn2 *x, big y, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_imul(_MIPD_ zzn2 *x, int y, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_sqr(_MIPD_ zzn2 *x, zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void zzn2_mul(_MIPD_ zzn2 *x, zzn2 *y, zzn2 *w) {
...
*/
__FUNCTION_HEADER__ void zzn2_inv(_MIPD_ zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_div2(_MIPD_ zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_div3(_MIPD_ zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_div5(_MIPD_ zzn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_timesi(_MIPD_ zzn2 *u) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
    if (mr_mip->ERNUM) return;
...
__FUNCTION_HEADER__ void zzn2_txx(_MIPD_ zzn2 *u) {
...
__FUNCTION_HEADER__ void zzn2_txd(_MIPD_ zzn2 *u) { /* divide w by t^2 where x^2-t is irreducible polynomial for ZZn4
...
__FUNCTION_HEADER__ BOOL zzn2_multi_inverse(_MIPD_ int m, zzn2 *x, zzn2 *w) {
    int i;
    zzn2 t1, t2;
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
