...
__FUNCTION_HEADER__ void ecn2_mirvar(_MIPD_ ecn2 *q) {
    zzn2_mirvar(_MIPP_ &(q->x));
    zzn2_mirvar(_MIPP_ &(q->y));
    zzn2_mirvar(_MIPP_ &(q->z));
}

__FUNCTION_HEADER__ void ecn2_kill(_MIPD_ ecn2 *q) {
    zzn2_kill(_MIPP_ &(q->x));
    zzn2_kill(_MIPP_ &(q->y));
    zzn2_kill(_MIPP_ &(q->z));
}

__FUNCTION_HEADER__ BOOL ecn2_iszero(ecn2 *a) {
    if (a->marker == MR_EPOINT_INFINITY) return TRUE;
    return FALSE;
}

__FUNCTION_HEADER__ void ecn2_copy(ecn2 *a, ecn2 *b) {
    zzn2_copy(&(a->x), &(b->x));
    zzn2_copy(&(a->y), &(b->y));
...
__FUNCTION_HEADER__ void ecn2_zero(ecn2 *a) {
    zzn2_zero(&(a->x));
    zzn2_zero(&(a->y));
#ifndef MR_AFFINE_ONLY
...
__FUNCTION_HEADER__ BOOL ecn2_compare(_MIPD_ ecn2 *a, ecn2 *b) {
#ifdef MR_OS_THREADS
...
__FUNCTION_HEADER__ void ecn2_norm(_MIPD_ ecn2 *a) {
    zzn2 t;
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void ecn2_get(_MIPD_ ecn2 *e, zzn2 *x, zzn2 *y, zzn2 *z) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void ecn2_getxy(ecn2 *e, zzn2 *x, zzn2 *y) {
    zzn2_copy(&(e->x), x);
    zzn2_copy(&(e->y), y);
}

__FUNCTION_HEADER__ void ecn2_getx(ecn2 *e, zzn2 *x) {
    zzn2_copy(&(e->x), x);
}

__FUNCTION_HEADER__ void ecn2_psi(_MIPD_ zzn2 *psi, ecn2 *P) { /* apply GLS morphism to P */
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void ecn2_getz(_MIPD_ ecn2 *e, zzn2 *z) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void ecn2_rhs(_MIPD_ zzn2 *x, zzn2 *rhs) { /* calculate RHS of elliptic curve equation */
    int twist;
    zzn2 A, B;
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
...
__FUNCTION_HEADER__ BOOL ecn2_set(_MIPD_ zzn2 *x, zzn2 *y, ecn2 *e) {
    zzn2 lhs, rhs;
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ void ecn2_setxyz(_MIPD_ zzn2 *x, zzn2 *y, zzn2 *z, ecn2 *e) {
    zzn2_copy(x, &(e->x));
    zzn2_copy(y, &(e->y));
    zzn2_copy(z, &(e->z));
...
__FUNCTION_HEADER__ BOOL ecn2_multi_norm(_MIPD_ int m, zzn2 *work, ecn2 *p) {
...
__FUNCTION_HEADER__ void ecn2_negate(_MIPD_ ecn2 *u, ecn2 *w) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ BOOL ecn2_add2(_MIPD_ ecn2 *Q, ecn2 *P, zzn2 *lam, zzn2 *ex1) {
    BOOL Doubling;
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ BOOL ecn2_add1(_MIPD_ ecn2 *Q, ecn2 *P, zzn2 *lam) {
    BOOL Doubling;
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ BOOL ecn2_add(_MIPD_ ecn2 *Q, ecn2 *P) {
    BOOL Doubling;
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ BOOL ecn2_sub(_MIPD_ ecn2 *Q, ecn2 *P) {
    BOOL Doubling;
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ BOOL ecn2_add_sub(_MIPD_ ecn2 *P, ecn2 *Q, ecn2 *PP,
...
__FUNCTION_HEADER__ BOOL ecn2_add3(_MIPD_ ecn2 *Q, ecn2 *P, zzn2 *lam, zzn2 *ex1, zzn2 *ex2) { /* P+=Q */
    BOOL Doubling = FALSE;
    int twist;
    int iA;
    zzn2 t1, t2, t3;
...
__FUNCTION_HEADER__  void ecn2_pre(_MIPD_ int sz, BOOL norm, ecn2 *PT) {
    int twist;
    int i, j;
    zzn2 A, B, C, D, E, T, W;
...
__FUNCTION_HEADER__ int ecn2_mul(_MIPD_ big k, ecn2 *P) {
...
__FUNCTION_HEADER__ int ecn2_mul2_jsf(_MIPD_ big a, ecn2 *P, big b, ecn2 *Q, ecn2 *R) {
...
__FUNCTION_HEADER__ int ecn2_muln_engine(_MIPD_ int wa, int sza, int wb, int szb, big *ma, big *ma3, big *mb, big *mb3, ecn2 *Ta, ecn2 *Tb,
...
__FUNCTION_HEADER__ void ecn2_precomp_gls(_MIPD_ int sz, BOOL norm, ecn2 *P, zzn2 *psi, ecn2 *T) {
    int i, j;
...
__FUNCTION_HEADER__ int ecn2_mul2_gls(_MIPD_ big *a, ecn2 *P, zzn2 *psi, ecn2 *R) {
    int i, j, nadds;
...
__FUNCTION_HEADER__ int ecn2_mul4_gls_v(_MIPD_ big *a, int ns, ecn2 *FT, big *b, ecn2 *Q, zzn2 *psi, ecn2 *R) {
    int i, j, nadds;
...
__FUNCTION_HEADER__ void ecn2_precomp(_MIPD_ int sz, BOOL norm, ecn2 *P, ecn2 *T) {
#ifdef MR_OS_THREADS
    miracl *mr_mip=get_mip();
#endif
...
__FUNCTION_HEADER__ int ecn2_mul2(_MIPD_ big a, int ns, ecn2 *FT, big b, ecn2 *Q, ecn2 *R) {
    int i, j, nadds;
    ecn2 T[2 * MR_ECC_STORE_N2];
    big a3, b3;
#ifdef MR_OS_THREADS
...
__FUNCTION_HEADER__ BOOL ecn2_brick_init(_MIPD_ ebrick *B, zzn2 *x, zzn2 *y, big a, big b, big n, int window, int nb) { /* Uses Montgomery arithmetic internally              *
...
__FUNCTION_HEADER__ void ecn2_brick_end(ebrick *B) {
    mirkill(B->n);
    mirkill(B->b);
    mirkill(B->a);
    mr_free(B->table);
...
__FUNCTION_HEADER__ void ecn2_mul_brick_gls(_MIPD_ ebrick *B, big *e, zzn2 *psi, zzn2 *x, zzn2 *y) {
...
__FUNCTION_HEADER__ void ecn2_mult4(_MIPD_ big *e, ecn2 *P, ecn2 *R) { /* R=e[0]*P[0]+e[1]*P[1]+ .... e[n-1]*P[n-1]   */
    int i, j, k, l, nb, ea, c;
    ecn2 G[16];
    zzn2 work[16];
#ifdef MR_OS_THREADS
...
__FUNCTION_HEADER__ void ecn2_multn(_MIPD_ int n, big *e, ecn2 *P, ecn2 *R) { /* R=e[0]*P[0]+e[1]*P[1]+ .... e[n-1]*P[n-1]   */
    int i, j, k, l, nb, ea, c;
    int m = 1 << n;
    ecn2 *G;
    zzn2 *work;
